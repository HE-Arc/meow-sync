...
<template>
    <div class="flex flex-col items-center justify-center text-center">
        ...
        <div class="flex space-x-4 flex-col gap-2 items-center justify-center">
            <p class="text-xl" v-if="user && user.connections.length >= 2">
                Go to your
            ...
            <p class="text-xl" v-else-if="user && user.connections.length < 2">
                You need to connect at least two music providers to create a
                sync pair. Go to your
                <RouterLink to="/settings" class="text-primary hover:underline"
                    >settings</RouterLink
                >
